...
func main() {
	...
	MQTT.CRITICAL = log.New(os.Stderr, "CRITICAL ", log.Ldate|log.Ltime|log.Lshortfile)
	MQTT.WARN = log.New(os.Stderr, "WARN ", log.Ldate|log.Ltime|log.Lshortfile)
	MQTT.ERROR = log.New(os.Stderr, "ERROR ", log.Ldate|log.Ltime|log.Lshortfile)
	MQTT.DEBUG = log.New(os.Stderr, "DEBUG ", log.Ldate|log.Ltime|log.Lshortfile)

	MQTT.CRITICAL.SetOutput(f)
	MQTT.DEBUG.SetOutput(f)
	MQTT.WARN.SetOutput(f)
	MQTT.ERROR.SetOutput(f)
